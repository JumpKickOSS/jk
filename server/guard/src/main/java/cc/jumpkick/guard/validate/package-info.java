 ...
 * table partitions its own vocabulary and that every compiled {@code @Tag} is in it. Validations
 * ride the guard lanes — a workspace without guards runs none — and report under reserved codes no
 * user rule may take.
 */
@NullMarked
