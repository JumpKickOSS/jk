 ...
 */
public final class ImageCredentials {
    ...
    public static void write(
            SpecWriter sw, String baseRef, ImageConfig config, JkBuild project, boolean push, Path dir) {
    ...
    public static RepoCredential resolve(String reference, Path moduleDir) {
     ...
     */
    public static Path newSpecFile() throws IOException {
        try {
