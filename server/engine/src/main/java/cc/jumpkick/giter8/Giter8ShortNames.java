 ...
 * Giter8 apply copies the tree the template ships ({@code jk_layout}). Framework templates may
 * use {@code custom} (e.g. Grails).
 */
public final class Giter8ShortNames {
    ...
    private static final List<Entry> ENTRIES = List.of(
            entry("cli", "Simple executable (Mill SIMPLE layout)", LAYOUT_SIMPLE, "java", "kotlin"),
            entry("cli-native", "Interactive Java CLI with JLine (jk native ready)", LAYOUT_SIMPLE, "java"),
            entry("spring-boot-webmvc", "Spring Boot WebMVC + JPA/H2 + Actuator", LAYOUT_TRADITIONAL, "java", "kotlin"),
            ...
            entry("micronaut", "Micronaut HTTP service (compile-time DI, Netty)", LAYOUT_SIMPLE, "java", "kotlin"),
