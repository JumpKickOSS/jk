...
class OutdatedPlansGitTest {

    @Test
    void latest_is_highest_stable_tag_tip_is_prerelease_ahead() {
        String[] r = OutdatedPlans.gitLatestAndTip(List.of("v1.0.0", "v1.1.0", "v2.0.0-rc1"));
    ...
    void tip_falls_back_to_moving_head_when_no_prerelease_is_ahead() {
        String[] r = OutdatedPlans.gitLatestAndTip(List.of("v1.0.0", "v1.2.0"));
    ...
    void non_version_tags_are_ignored() {
        String[] r = OutdatedPlans.gitLatestAndTip(List.of("latest", "nightly", "v3.4.5"));
        assertThat(r[0]).isEqualTo("v3.4.5");
    }

    @Test
    void empty_when_no_version_like_tags() {
        String[] r = OutdatedPlans.gitLatestAndTip(List.of("main", "release"));
