 ...
 */
class CachePlansEvictionBudgetTest {

    @Test
    void default_store_budget_never_evicts() {
        assertThat(CachePlans.storeEvictionBudgetBytes(null, JkCacheConfig.DEFAULTS))
                .isZero();
    }
    ...
    void explicitly_configured_budget_evicts_to_it() {
        ...
        assertThat(CachePlans.storeEvictionBudgetBytes(null, configured))
    ...
    void explicit_max_size_wins_over_config() {
        JkCacheConfig configured = new JkCacheConfig(true, 2048, 7, 30, 1024, true);
        assertThat(CachePlans.storeEvictionBudgetBytes("1G", configured))
                .isEqualTo(1024L * 1024 * 1024);
        assertThat(CachePlans.storeEvictionBudgetBytes("512M", JkCacheConfig.DEFAULTS))
