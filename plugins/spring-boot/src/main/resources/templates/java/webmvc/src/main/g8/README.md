...
Multi-module Spring Boot WebMVC app (Java $java$, virtual threads). Scaffolded from the
jk `spring-boot` plugin kind `webmvc`.

```text
data/     entities, Spring Data JPA, Flyway migrations, H2
