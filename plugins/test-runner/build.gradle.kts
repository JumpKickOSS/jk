...
dependencies {
    // Engine/launcher are compileOnly so the forked test JVM uses the project's version
    // (Quarkus hooks LauncherSessionListener on it). Matches jk.toml [provided-dependencies].
