 ...
 * proto dir, the proto dirs of the workspace siblings the module depends on, config, the runtime
 * and compile classpaths whose jars may carry importable protos, the fetched binaries) and skips
