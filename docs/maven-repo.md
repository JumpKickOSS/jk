...
repo/
  cc/jumpkick/
    jk-test-runner/
      0.10.1/
        jk-test-runner-0.10.1.jar
        jk-test-runner-0.10.1.jar.sha256
        jk-test-runner-0.10.1.pom
      maven-metadata.xml
    jk-kotlin-compiler/
      …
```
...
scripts/assemble-release-dir.sh build/release/0.10.1
# upload releases/
gsutil -m rsync -r build/release/0.10.1/ gs://jkbuild-releases/releases/0.10.1/
