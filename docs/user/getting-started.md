...
| `target/jk-results.md` | High-level report of the last run (read this when something fails) |

When a build fails: [Troubleshooting](troubleshooting.md). Next: [Manual](manual.md) for
