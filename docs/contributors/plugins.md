...
```toml
[dependencies]
jk-plugin-sdk = "cc.jumpkick:jk-plugin-sdk:0.13.8"     # the release you compile against
```
...
table     = "hello"
version   = "0.1.0"
sdk       = "0.13.8"          # the jk-plugin-sdk release you compiled against — the pin above
...
version   = "1.0.0"
jk-compat = ">=0.10"
# sdk = "0.13.8"              # out-of-tree plugins: the jk-plugin-sdk release compiled against
