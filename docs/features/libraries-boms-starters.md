...
`[platform-dependencies]`, `GradleVersionCatalog` / `GradleImporter`, Boot plugin / `jk new -t spring-boot/hello`
...
3. Templates (`jk new -t spring-boot/hello`) and plugins (packaging/dev) for the stack.
