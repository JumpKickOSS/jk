...
public final class ProtoEvents {
     ...
     *     cc.jumpkick.wire.runtime.WorkspaceProgressTracker} (clock or weighted); {@link Double#NaN}
    ...
    private static String diagnosticLike(
        ...
        if (stack != null && !stack.isEmpty()) b.append(",\"stack\":").append(Jsonl.quote(stack));
    ...
    public static String lockPackage(String dir, String name, String version, int totalSeen) {
        ...
        if (totalSeen >= 0) sb.append(",\"total\":").append(totalSeen);
        sb.append('}');
        return sb.toString();
    }
