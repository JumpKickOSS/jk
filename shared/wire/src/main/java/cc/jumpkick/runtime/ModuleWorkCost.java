 ...
 */
public record ModuleWorkCost(Path dir, Set<Path> prereqs, int weight, int testWeight, int tailWeight) {
    ...
    public ModuleWorkCost(Path dir, Set<Path> prereqs, int weight, int testWeight) {
