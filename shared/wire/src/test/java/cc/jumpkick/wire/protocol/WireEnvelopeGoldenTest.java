...
class WireEnvelopeGoldenTest {
    ...
    void hello_and_ack_carry_version_and_proto() {
        String hello = ProtoLifecycle.hello("0.12.0", "connect");
        ...
        String ack = ProtoLifecycle.helloAck("0.12.0", 1L, 100L, false, "bid");
    ...
    void error_envelope_has_code_and_message() {
        String err = ProtoLifecycle.error(EngineProtocol.ERR_DEADLINE, "too long");
    ...
    void workspace_progress_carries_aggregate_fields() {
        String line = ProtoEvents.workspaceProgress("/ws", 150, 200, "execute", 1, 3);
