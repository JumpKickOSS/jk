 ...
 * and one holding {@code &} turned a project file into one the IDE refuses to parse. {@code "}
 * is not a legal Windows path character, so the Path fixtures use {@code &}; quote escaping is
 * {@link cc.jumpkick.util.MinimalXml#escapeAttr}.
 */
class IntellijXmlEscapingTest {
    ...
    @Test
    void a_quote_in_an_attribute_is_escaped() {
        assertThat(MinimalXml.escapeAttr("out&\"put")).isEqualTo("out&amp;&quot;put");
    }
}
