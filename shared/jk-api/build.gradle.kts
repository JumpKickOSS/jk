...
description = "jk-api: the stable front-end/plugin contract (IO/thread machinery lives in :core) — BuildPlan/Step scheduler SPI, " +
...
// internal classpath to get BuildPlan, Step, Coordinate, the command SPI, etc. A
