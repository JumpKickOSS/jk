...
class PipelineDiagnosticMessageTest {
    ...
    void closed_messages_include_exception_class() {
        ...
        assertThat(Pipeline.diagnosticMessage(new RuntimeException("real failure")))
                .isEqualTo("real failure");
        assertThat(Pipeline.diagnosticMessage(new RuntimeException())).isEqualTo("RuntimeException");
    }
}
