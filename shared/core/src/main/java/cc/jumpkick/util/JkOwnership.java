...
public final class JkOwnership {
     ...
     *
     * <p>Decoration, not evidence. Launchers live in {@code <home>/bin}, which jk owns outright, so
     * containment answers the delete question and nothing parses this string. It is for a human who
     * opens the file.
     */
