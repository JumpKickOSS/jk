...
public final class RunCommand {
    ...
    public RunCommand(GlobalOptions global, BuildOptions buildOpts) {
        this.global = global;
        this.buildOpts = buildOpts;
    }

    /** Package-private: {@code jk tool run <dir>} delegates a jk-project directory here. */
    public int runProject(Path projectDir, List<String> appArgs) throws IOException, InterruptedException {
