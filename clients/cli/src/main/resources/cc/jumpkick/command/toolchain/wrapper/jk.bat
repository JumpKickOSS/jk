...
set "VERSION="
for /f "usebackq delims=" %%V in (`powershell -NoProfile -Command "(Invoke-WebRequest -UseBasicParsing ($env:JK_RELEASES_URL + '/latest/VERSION')).Content.Trim()"`) do set "VERSION=%%V"
if not defined VERSION (
  echo jk wrapper: could not read !JK_RELEASES_URL!/latest/VERSION - offline, or JK_RELEASES_URL is wrong. 1>&2
  exit /b 1
)
