 ...
 * </ul>
 *
 * <p>Warm engine across methods (ticket-1042). TempDir cleanup uses {@link
 * JkTempDirDeletionStrategy} (ticket-1055): stop engine only when a delete fails, so the former
