...
/**
 * Test-classpath fixtures: first-party `jk-plugin.toml` under `cc/jumpkick/plugin/manifest/`. Production jars carry
 * their own manifest at the zip root instead. Never `:core` main / the native CLI.
 */
