    ...
    val all: List<GuardSpec> =
        listOf(
            ...
            spec(
                ...
                GuardHome.ROOT,
                tableTask =
                    "`checkBootstrapVersions` (root project) + `.jk/after-build.kts` (Node pin) + `wrapper-version-parity` (jk-guards.toml)",
                attach = emptySet(),
